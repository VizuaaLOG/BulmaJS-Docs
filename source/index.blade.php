        ...
        <div class="container">
            <div class="columns">
                <div class="column">
                    ...
                    <p class="title is-4 has-margin-top-4 has-margin-bottom-2">Modern</p>
                ...
                <div class="column">
                    ...
                    <p class="title is-4 has-margin-top-4 has-margin-bottom-2">Pluggable</p>
                ...
                <div class="column">
                    ...
                    <p class="title is-4 has-margin-top-4 has-margin-bottom-2">Dependency free</p>
                ...
                <div class="column">
                    ...
                    <p class="title is-4 has-margin-top-4 has-margin-bottom-2">Open source</p>
